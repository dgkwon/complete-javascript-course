...
// Passing "argument" into handler => "argument" will become this in the handler
...
const slider = function () {
  ...
  const nextSlide = function () {
    if (curSlide === maxSlde - 1) curSlide = 0;
    else curSlide++;
  ...
  const prevSlide = function () {
    if (curSlide === 0) curSlide = maxSlde - 1;
    else curSlide--;
